...
#import "CRASHPROTECTORAppDelegate.h"
#import <CrashProtector/CrashProtector.h>

@implementation CRASHPROTECTORAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [CPLogger setReportBridge:^(NSException * _Nonnull exception, NSArray * _Nonnull callStackSymbols, NSString * _Nonnull slideAddress) {
        ...
        NSLog(@"slideAddress = %@", slideAddress);
        NSLog(@"Caught a crash: %@ \n%@", exception.reason, callStackSymbols);
    }];
